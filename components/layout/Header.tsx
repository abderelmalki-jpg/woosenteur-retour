...
import { LoginOrRegisterPopup } from '@/components/auth/LoginOrRegisterPopup';
...
export default function Header() {
  ...
  return (
    <>
                ...
                {user ? (
                  ...
                  <>
                    ...
                    <Button 
                      ...
                      className="font-body text-sm font-medium text-gray-700 hover:text-[#6B46C1] transition-colors py-2 text-left justify-start"
                    >
                      Connexion
                    </Button>
                    <Link 
      ...
      <LoginOrRegisterPopup open={showLoginPopup} onOpenChange={setShowLoginPopup} />
    </>
  );
}
